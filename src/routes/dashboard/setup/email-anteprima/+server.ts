...
export const GET: RequestHandler = async ({ url, locals: { user } }) => {
	...
	const ALL: Record<string, () => { subject: string; html: string; tag?: string }> = {
		...
		ordine_da_preventivo: () => T.quoteOrderEmail({ name: 'Mattia', quoteNumber: 'SPP00001', number: 'SP00038', items, total: '866,20 €', shipDate: '30 settembre 2026', leadTime: '12 giorni lavorativi', payments: [{ label: 'Bonifico bancario vista fattura', amount: '866,20 €', due: '30 settembre 2026', upfront: false, paid: false }], dueNow: null, senderName: 'Mattia', href: `${o}/conferma/esempio` }),
		ordine_da_preventivo_anticipo: () => T.quoteOrderEmail({ name: 'Mattia', quoteNumber: 'SPP00001', number: 'SP00038', items, total: '866,20 €', shipDate: '30 settembre 2026', leadTime: '12 giorni lavorativi', payments: [{ label: 'Bonifico anticipato', amount: '433,10 €', due: null, upfront: true, paid: false }, { label: 'Ricevuta bancaria 30 gg f.m.', amount: '433,10 €', due: '31 ottobre 2026', upfront: false, paid: false }], dueNow: '433,10 €', senderName: 'Mattia', href: `${o}/conferma/esempio` }),
