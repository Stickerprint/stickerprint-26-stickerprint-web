...
<svelte:head><title>Come gestiamo le recensioni | Stickerprint</title><meta name="description" content="Da dove vengono le recensioni su Stickerprint, come le verifichiamo, cosa pubblichiamo e cosa no." /></svelte:head>
...
<section class="section container" style="max-width:760px">
	...
	<div class="card" style="padding:28px;margin-top:22px;display:grid;gap:18px;font-size:15.5px;line-height:1.6">
		...
		<div><b>Vuoi correggere o togliere la tua?</b> Scrivici a <a class="link" href="mailto:info@stickerprint.it">info@stickerprint.it</a> dallo stesso indirizzo dell'ordine.</div>
	</div>
</section>
