<script lang="ts">
	/** "Te li portiamo fino alla porta": i quattro passi, in home e nelle offerte */
	let { shipDate, dark = false }: { shipDate: string; dark?: boolean } = $props();
</script>

<section class="section container center howto-wrap" class:is-dark={dark}>
