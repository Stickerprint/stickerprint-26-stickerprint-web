...
<section class="cfg" class:cfg--test={test} id="configura">
	...
	<div class="cfg__summary">
		<div class="sum sum--ship">
			...
			<div class="sum__text"><span class="sum__label">Spedizione stimata</span><span class="sum__value">{shipDate}</span><span class="sum__sub">Corriere espresso tracciato</span></div>
		</div>
