/** Contenuti delle pagine prodotto (testi e foto ripresi dal sito attuale, adattati al nuovo stile). */
export interface ProductContent { slug: string; route: string; name: string; title: string; sub: string; desc: string; checks: string[]; cosa: string; gallery: string[]; others: string[]; faq: { q: string; a: string }[]; engineProduct: 'sticker' | 'resinati'; cta: string; articolo: string }
...
export const PRODUCTS: Record<string, ProductContent> = {
	adesivi_personalizzati: {
		...
		engineProduct: 'sticker', cta: 'i tuoi Adesivi personalizzati', articolo: 'questi adesivi'
	},
	adesivi_resinati: {
		...
		engineProduct: 'resinati', cta: 'i tuoi Adesivi resinati', articolo: 'questi adesivi'
	},
	adesivi_rilievo: {
		...
		engineProduct: 'sticker', cta: 'i tuoi Adesivi in rilievo', articolo: 'questi adesivi'
	},
	etichette: {
		...
		engineProduct: 'sticker', cta: 'le tue Etichette in fogli', articolo: 'queste etichette'
	},
	fogli_adesivi: {
		...
		engineProduct: 'sticker', cta: 'i tuoi Fogli di adesivi', articolo: 'questi fogli'
	},
	vetrofanie: {
		...
		engineProduct: 'sticker', cta: 'le tue Vetrofanie', articolo: 'queste vetrofanie'
	},
};
