...
export const PRODUCTS: Record<string, ProductContent> = {
	adesivi_personalizzati: {
		...
		checks: ['Prova automatica immediata', 'Pronti per la spedizione entro {ship}', 'Stampiamo solo se viene bene', 'Nessuna sorpresa sul risultato'],
	...
	adesivi_resinati: {
		...
		checks: ['Resina premium ultra brillante', 'Prova automatica immediata', 'Pronti per la spedizione entro {ship}', 'Stampiamo solo se viene bene', 'Nessuna sorpresa sul risultato'],
	...
	adesivi_rilievo: {
		...
		checks: ['Prova automatica immediata', 'Pronti per la spedizione entro {ship}', 'Stampiamo solo se viene bene', 'Nessuna sorpresa sul risultato', 'Effetto rilievo applicato con precisione'],
	...
	fogli_adesivi: {
		...
		checks: ['Prova automatica immediata', 'Pronti per la spedizione entro {ship}', 'Mezzo taglio su ogni adesivo (si staccano facile)', 'Più sagome diverse nello stesso foglio', 'Stampiamo solo se viene bene'],
