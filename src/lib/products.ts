...
export const PRODUCTS: Record<string, ProductContent> = {
	adesivi_personalizzati: {
		...
		checks: ['Prova automatica immediata', 'Spedizione stimata {ship}', 'Stampiamo solo se viene bene', 'Nessuna sorpresa sul risultato'],
	...
	adesivi_resinati: {
		...
		checks: ['Resina premium ultra brillante', 'Prova automatica immediata', 'Spedizione stimata {ship}', 'Stampiamo solo se viene bene', 'Nessuna sorpresa sul risultato'],
	...
	fogli_adesivi: {
		...
		checks: ['Prova automatica immediata', 'Spedizione stimata {ship}', 'Mezzo taglio su ogni adesivo (si staccano facile)', 'Più sagome diverse nello stesso foglio', 'Stampiamo solo se viene bene'],
