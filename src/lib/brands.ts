/** Loghi dei brand per cui abbiamo stampato: immagine in /images/brands, oppure solo il nome se il logo non c'è ancora.
 *  Usati nella home ("Abbiamo stampato per") e nella pagina aziende ("Abbiamo fornito adesivi e esperienza per"). */
